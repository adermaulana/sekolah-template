...
if($_SESSION['status'] != 'login'){
    ...
    header("location:../");
        ...
        if(isset($_GET['hal'])){
            if($_GET['hal'] == "edit"){
                $tampil = mysqli_query($koneksi, "SELECT * FROM jurusan WHERE id = '$_GET[id]'");
                $data = mysqli_fetch_array($tampil);
                if($data){
                    $namajurusan = $data['namajurusan'];
                    $namajurusan = $data['deskripsi'];
                    $namajurusan = $data['gambar'];
                }
            }
        }
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <a href="jurusan.php" class="btn btn-success btn-icon-split">
                        ...
                        <form method="post" class="user" enctype="multipart/form-data">
                            <div class="form-group">
                                <input type="text" name="namajurusan" class="form-control form-control-user col-6"
                                    placeholder="Nama Jurusan" value="<?= $data['namajurusan'] ?>">
                            </div>
                            ...
                            <div class="form-group">
                                <input type="file" name="gambar" required value="<?= $data['gambar'] ?>" class="form-control form-control-user col-6"
                                    placeholder="Foto">
                            </div>
                            <div class="form-group">
