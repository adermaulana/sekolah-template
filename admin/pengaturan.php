...
if($_SESSION['status'] != 'login'){
    ...
    header("location:../");
                ...
                if($data){
                    $visi = $data['namasekolah'];
                    $misi = $data['alamat'];
                    $misi = $data['email'];
                    $misi = $data['telp'];
                    $misi = $data['logo'];
                    $misi = $data['jumlahsiswa'];
                }
        ...
        if(isset($_POST['simpan'])){
                    ...
                    $gambar_temp = $_FILES['logo']['tmp_name'];
                    $upload_dir = 'uploads/'; // Specify your upload directory

                    $lokasi_logo="uploads/" . $logo;
                    // Move uploaded file to the specified directory
                    move_uploaded_file($gambar_temp, $upload_dir . $logo);

            $simpan = mysqli_query($koneksi, "UPDATE pengaturan SET
        ...
        if($simpan){
            echo "<script>
                    ...
                    document.location='pengaturan.php';
                </script>";
        } else {
            echo "<script>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="row">
                            ...
                            <div class="mb-4 col-6">
                                ...
                                <input type="file" name="logo" required value="<?= $data['logo'] ?>" class="form-control">
                            </div>
                            <div class="mb-4 col-6">
                                <label class="form-label">Jumlah Siswa</label>
                                <input type="number" name="jumlahsiswa" value="<?= $data['jumlahsiswa'] ?>" class="form-control">
                            </div>
                        </div>
