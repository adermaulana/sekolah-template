<?php
    ...
    if (isset($_POST['simpan'])) {
        ...
        $simpan = mysqli_query($koneksi, "INSERT INTO guru (nama, email, alamat,keahlian,foto) VALUES ('$_POST[nama]','$_POST[email]','$_POST[alamat]','$_POST[keahlian]','$lokasi_foto')");
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <form method="post" class="user" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <input type="email" name="email" class="form-control form-control-user col-6"
                                    placeholder="Email">
                            </div>
                            <div class="form-group">
                                <input type="text" name="alamat" class="form-control form-control-user col-6"
                                    placeholder="Alamat">
                            </div>
                            <div class="form-group">
                                <input type="text" name="keahlian" class="form-control form-control-user col-6"
                                    placeholder="Keahlian">
                            </div>
                            <div class="form-group">
                                <input type="file" name="foto" required class="form-control form-control-user col-6"
                                    placeholder="Foto">
                            </div>
                            <div class="form-group">
