...
if(isset($_GET['hal'])){
    if($_GET['hal'] == "jurusan"){
        $tampil = mysqli_query($koneksi, "SELECT * FROM jurusan WHERE namajurusan = '$_GET[nama]'");
        $data = mysqli_fetch_array($tampil);
        if($data){
...
<head>
  ...
  <title>Profil - <?= $namajurusan ?></title>
    ...
    <div class="container-fluid container-xl position-relative d-flex align-items-center">
      ...
      <nav id="navmenu" class="navmenu">
        <ul>
          ...
          <li class="dropdown"><a href="#"><span class="active">Jurusan</span> <i class="bi bi-chevron-down toggle-dropdown active"></i></a>
            <ul>
            <?php
              $no = 1;
      ...
      <div class="container">
        <nav class="breadcrumbs">
          <ol>
            ...
            <li class="current"><?= $namajurusan ?></li>
          </ol>
        </nav>
        <h1><?= $namajurusan ?></h1>
      </div>
