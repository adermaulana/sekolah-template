...
if(isset($_POST['simpan'])){
    ...
    $simpan = mysqli_query($koneksi, "INSERT INTO ekstrakurikuler (namaekskul,deskripsi,gambar) VALUES ('$_POST[namaekskul]','$_POST[deskripsi]','$lokasi_gambar')");
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <form method="post" class="user" enctype="multipart/form-data">
                            ...
                            <div class="form-group col-6">
                                ...
                                <textarea name="deskripsi" class="form-control" id="exampleFormControlTextarea1" rows="6"></textarea>
                            </div>
                            <div class="form-group">
                                <input type="file" name="gambar" required class="form-control form-control-user col-6"
                                    placeholder="Gambar">
                            </div>
                            <div class="form-group">
