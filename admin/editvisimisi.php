...
if($_SESSION['status'] != 'login'){
    ...
    header("location:../");
        ...
        if(isset($_GET['hal'])){
            if($_GET['hal'] == "edit"){
                $tampil = mysqli_query($koneksi, "SELECT * FROM visimisi WHERE id = '$_GET[id]'");
        ...
        if(isset($_POST['simpan'])){
            ...
            $simpan = mysqli_query($koneksi, "UPDATE visimisi SET
                                                visi = '$_POST[visi]',
                                                misi = '$_POST[misi]'
                                                 WHERE id = '$_GET[id]'");
        ...
        if($simpan){
            echo "<script>
                    ...
                    document.location='visimisi.php';
                </script>";
        } else {
            echo "<script>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <a href="visimisi.php" class="btn btn-success btn-icon-split">
                        ...
                        <div class="form-group col-6">
                            ...
                            <textarea name="visi" class="form-control" id="exampleFormControlTextarea1" value="<?= $data['visi'] ?>" rows="3"><?=$data['visi'] ?></textarea>
                        </div>
                        <div class="form-group col-6">
                            <label for="exampleFormControlTextarea1">Misi</label>
                            <textarea name="misi" class="form-control" id="exampleFormControlTextarea1" value="<?= $data['misi'] ?>" rows="3"><?=$data['misi'] ?></textarea>
                        </div>
