...
if($_SESSION['status'] != 'login'){
    ...
    header("location:../");
        ...
        if(isset($_GET['hal'])){
            if($_GET['hal'] == "edit"){
                $tampil = mysqli_query($koneksi, "SELECT * FROM ekstrakurikuler WHERE id = '$_GET[id]'");
        ...
        move_uploaded_file($gambar_temp, $upload_dir . $gambar);
            ...
            $simpan = mysqli_query($koneksi, "UPDATE ekstrakurikuler SET
                                                namaekskul = '$_POST[namaekskul]',
                                                deskripsi = '$_POST[deskripsi]',
                                                gambar = '$lokasi_gambar'
                                                 WHERE id = '$_GET[id]'");
            
        if($simpan){
            echo "<script>
                    alert('Edit data sukses!');
                    document.location='ekstrakurikuler.php';
                </script>";
        } else {
            echo "<script>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <a href="ekstrakurikuler.php" class="btn btn-success btn-icon-split">
                        ...
                        <form method="post" class="user" enctype="multipart/form-data">
                            <div class="form-group">
                                <input type="text" name="namaekskul" class="form-control form-control-user col-6"
                                    placeholder="Nama Ekstrakurikuler" value="<?= $data['namaekskul'] ?>">
                            </div>
                            <div class="form-group col-6">
                                <label for="exampleFormControlTextarea1">Deskripsi</label>
                                <textarea name="deskripsi" class="form-control" id="exampleFormControlTextarea1" value="<?= $data['deskripsi'] ?>" rows="6"><?= $data['deskripsi'] ?></textarea>
                            </div>
                            <div class="form-group">
                                <input type="file" name="gambar" required value="<?= $gambar ?>" class="form-control form-control-user col-6"
                                    placeholder="Gambar">
                            </div>
                            <div class="form-group">
